...
import { MessageCircle, Users, Sparkles, Ambulance, CreditCard, Phone, Search, Menu, ChevronLeft, Star } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      <div className="p-4 flex items-center justify-between border-b border-border/50">
        ...
        <Button
          ...
          className="hidden md:flex hover:bg-gray-100/5"
        >
